                    ...
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div id="cache-settings" @class(['mb-4 border rounded-top rounded-bottom p-3 bg-light', 'd-none' => ! setting('enable_cache')])>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <label class="me-2">
                                    <input type="radio" name="disable_cache_in_the_admin_panel" value="1" @checked(setting('disable_cache_in_the_admin_panel'))>
                                    {{ trans('core/setting::setting.general.yes') }}
                                </label>
                                <label>
                                    <input type="radio" name="disable_cache_in_the_admin_panel" value="0" @checked(! setting('disable_cache_in_the_admin_panel'))>
                                    {{ trans('core/setting::setting.general.no') }}
                                </label>
                            </div>
                        </div>
