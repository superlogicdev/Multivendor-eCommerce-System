...
@section('content')
                                ...
                                <div class="wrap-table-shipping-{{ $shippingItem->id }}">
                                    <div class="pd-all-20 p-none-b">
                                        ...
                                        <a href="#" class="btn-change-link float-end excerpt btn-confirm-delete-region-item-modal-trigger text-danger"
                                            data-id="{{ $shippingItem->id }}" data-name="{{ $shippingItem->title }}">{{ trans('plugins/ecommerce::shipping.delete') }}</a>
                                    </div>
    ...
    {!! Form::modalAction('add-shipping-rule-item-modal', trans('plugins/ecommerce::shipping.add_shipping_fee_for_area'), 'info', view('plugins/ecommerce::shipping.rules.form', ['rule' => null])->render(), 'add-shipping-rule-item-button', trans('plugins/ecommerce::shipping.save')) !!}
    ...
    {!! Form::modalAction('form-shipping-rule-item-detail-modal', '', 'info', '', 'save-shipping-rule-item-detail-button', trans('plugins/ecommerce::shipping.save')) !!}
    {!! Form::modalAction('confirm-delete-shipping-rule-item-modal', trans('plugins/ecommerce::shipping.rule.item.delete'), 'info', trans('plugins/ecommerce::shipping.rule.item.confirmation'), 'confirm-delete-shipping-rule-item-button', trans('plugins/ecommerce::shipping.confirm'), 'modal-xs') !!}
@stop
