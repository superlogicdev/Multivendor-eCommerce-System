                        ...
                        <div class="ps-product__header">
                            ...
                            <div class="ps-product__info">
                                ...
                                <div class="ps-product__sharing">
                                    ...
                                    <a class="twitter" href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode(strip_tags(SeoHelper::getDescription())) }}" target="_blank"><i class="fa fa-twitter"></i></a>
